 ...
 */
export const ManufacturerControls = ({ onAddItem, onImport, onExport, onClearData, filters, setFilters, title, tableView, setTableView }) => {
    ...
    const exportItems = async (format) => {
        ...
        switch (format) {
            ...
            case 'pdf': {
                ...
                autoTable(doc, {
                    startY: 30,
                    head: [['Name', 'Status', 'Materials', 'Region', 'Country']],
                    body: items.map(i => [i.name, i.approvalStatus, i.materials, i.region, i.country]),
                    styles: { fontSize: 8 },
    ...
    return html`
        <div className="controls-container manufacturer-controls">
            <div className="main-controls">
                <button type="button" className="control-btn" onClick=${onAddItem}>Add Manufacturer</button>
